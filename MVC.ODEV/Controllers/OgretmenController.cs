...
using MVC.ODEV.Models;

namespace MVC.ODEV.Controllers
{
    public class OgretmenController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OgrtID,OgrtAd,OgrtSoyad,OgrtYas")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OgrtID,OgrtAd,OgrtSoyad,OgrtYas")] Table table)
        {
            if (ModelState.IsValid)
            {
